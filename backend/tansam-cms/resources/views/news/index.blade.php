...
<div class="container">
    <div class="top-section d-flex justify-content-between align-items-center pt-3 pb-3">
        <div>
            ...
            <div class="text-muted" style="font-size: 1rem;">Manage all news from here.</div>
        </div>
        <a href="{{ route('news.create') }}" class="btn btn-primary mb-3 d-flex align-items-center gap-2">
        ...
        @foreach($news as $newsItem)
            <tr>
                <td class="align-middle">
                    <a href="{{ route('news.editForm', $newsItem->id) }}"
                ...
                <td class="align-middle text-center">
                    <button class="delete-btn btn btn-link p-0" data-id="{{ $newsItem->id }}" title="Delete" style="color: red;">
